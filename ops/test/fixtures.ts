  ...
  return [
    ...
    },
    {
      ...
      entries: [
        ...
        { id: "supabase-small", availability: "available", approved: true },
        {
          id: "vercel-pro",
          availability: "available",
          approved: true,
          billable: true,
          pricing_sku_id: "vercel-pro-month",
        },
      ],
    },
    {
      ...
      entries: [
        ...
        { id: "vercel-pro-month", availability: "available", approved: true },
    ...
    },
    {
      ...
      entries: [
        ...
        { id: "ai.coaching", approved: true },
        { id: "ai.briefing.daily", approved: true },
        { id: "ai.briefing.weekly", approved: true },
        {
          id: "slack.reply_alerts",
          approved: true,
          required_secret_names: ["slack.reply_alerts"],
        },
        { id: "slack.briefings", approved: true },
        { id: "airtable.imports", approved: true },
      ],
    },
    {
      ...common,
...
const effects = [
  ...
  ["supabase_project", "create_or_adopt", "deterministic_name_and_owner_marker"],
  ["tenant_schema", "apply", "version_ledger"],
  ["storage_auth_smtp", "configure", "provider_request_id"],
  ["platform_support", "configure", "provider_request_id"],
  ["vercel_project", "create_or_adopt", "deterministic_name_and_owner_marker"],
...
export function makeOnboardingPlan(
  ...
  const spec: Record<string, unknown> = {
    ...
    resources: {
      ...
      supabase_organization_id: "sb-org-1",
      supabase_project_name: `lh2-external-${slug}`,
      vercel_team_id: "vc-team-1",
      vercel_project_name: `lh2-external-${slug}`,
    ...
    environment_policy: {
      ...
      public_build_value_names: ["VITE_SUPABASE_URL", "VITE_SUPABASE_ANON_KEY"],
    },
    auth_smtp: {
    ...
    effects: effects.map(([kind, action, reconcile], index) => ({
      ...
      billable: kind === "supabase_project" || kind === "vercel_project",
      ...
      components: [
        {
          ...
          low_minor: 2500,
          high_minor: 2500,
          assumption: "Selected Supabase tier",
        },
        {
          provider: "vercel",
          sku_id: "vercel-pro-month",
          quantity: 1,
          unit: "tenant_month",
          low_minor: 2000,
          high_minor: 2000,
          assumption: "Selected Vercel tier",
        },
        {
          provider: "anthropic",
...
export function executionContext(
  ...
  return {
    ...
    supabaseOrganizationId: String(resources.supabase_organization_id),
    supabaseProjectName: String(resources.supabase_project_name),
    supabaseRegionId: String(inputs.supabase_region_id),
    supabaseTierId: String(inputs.supabase_tier_id),
    supabaseComputeId: String(inputs.supabase_compute_id),
    vercelTeamId: String(resources.vercel_team_id),
    vercelProjectName: String(resources.vercel_project_name),
