/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 596d085273fe4ec300745521d5b486d1)
...
interface __BaseEnv_Env {
	...
	APPROVED_SOURCE_GIT_SHA: "51f7eefaff62edb7e5c5c4bef5a2cab254a532a0";
	...
	NEON_TIER_ID: string;
	NEON_COMPUTE_ID: string;
	NEON_BACKUP_PROFILE_ID: string;
	VERCEL_API_TOKEN: string;
	RESEND_API_KEY: string;
	RESEND_SMOKE_RECIPIENT: string;
	BETTER_AUTH_SESSION_SECRET: string;
	BETTER_AUTH_TEMPLATE_SET_ID: string;
	RELEASE_COMPATIBILITY_ID: string;
	APPROVED_APPLICATION_VERSION: string;
	APPROVED_SCHEDULE_MANIFEST_DIGEST: string;
	TENANT_DATABASE_URL: string;
	TENANT_DATA_API_PUBLIC_KEY: string;
	TENANT_DATA_API_ADMIN_KEY: string;
	TENANT_SCHEDULE_INVOKE_SECRET: string;
	TENANT_INGEST_INVOKE_SECRET: string;
	TENANT_TOOL_BRIDGE_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEON_API_BASE_URL" | "NEON_ORGANIZATION_ID" | "NEON_DATABASE_NAME" | "NEON_OWNER_ROLE_NAME" | "VERCEL_API_BASE_URL" | "VERCEL_TEAM_ID" | "VERCEL_BUILD_RECIPE_ID" | "RESEND_API_BASE_URL" | "RESEND_SMTP_PROFILE_ID" | "RESEND_SENDER_DOMAIN" | "RESEND_FROM_EMAIL" | "RESEND_FROM_IDENTITY" | "BETTER_AUTH_BASE_URL" | "SOURCE_REPOSITORY_API_BASE_URL" | "SOURCE_REPOSITORY_OWNER" | "SOURCE_REPOSITORY_NAME" | "APPROVED_SOURCE_GIT_SHA" | "RECOVERY_OBJECT_PREFIX" | "BRIDGE_BEARER_SECRET" | "NEON_API_TOKEN" | "NEON_REGION_ID" | "NEON_TIER_ID" | "NEON_COMPUTE_ID" | "NEON_BACKUP_PROFILE_ID" | "VERCEL_API_TOKEN" | "RESEND_API_KEY" | "RESEND_SMOKE_RECIPIENT" | "BETTER_AUTH_SESSION_SECRET" | "BETTER_AUTH_TEMPLATE_SET_ID" | "RELEASE_COMPATIBILITY_ID" | "APPROVED_APPLICATION_VERSION" | "APPROVED_SCHEDULE_MANIFEST_DIGEST" | "TENANT_DATABASE_URL" | "TENANT_DATA_API_PUBLIC_KEY" | "TENANT_DATA_API_ADMIN_KEY" | "TENANT_SCHEDULE_INVOKE_SECRET" | "TENANT_INGEST_INVOKE_SECRET" | "TENANT_TOOL_BRIDGE_SECRET" | "SOURCE_REPOSITORY_TOKEN">> {}
}
declare module "*.sql" {
	const value: string;
