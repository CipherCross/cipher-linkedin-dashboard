/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b22935606b2a9e25e9e5cdc8825606e3)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	CONTROL_PLANE_OBJECTS: R2Bucket;
	TENANT_LEAD_PHOTOS: R2Bucket;
	NEON_API_BASE_URL: "https://console.neon.tech/api/v2";
	NEON_ORGANIZATION_ID: "org-damp-hill-86577285";
	NEON_DATABASE_NAME: "neondb";
	NEON_OWNER_ROLE_NAME: "neondb_owner";
	NEON_APPLICATION_ROLE_NAME: "app_runtime";
	NEON_AI_ROLE_NAME: "app_system";
	NEON_MACHINE_ROLE_NAME: "app_machine";
	NEON_IDENTITY_STORE_ROLE_NAME: "identity_store";
	S26_APPLICATION_HOSTING_CONTRACT: "hosting.environment.v2";
	S26_APPLICATION_DATA_PLANE_READY: "true";
	NEON_REGION_ID: "aws-eu-central-1";
	NEON_TIER_ID: "neon-free";
	NEON_COMPUTE_ID: "autoscale-0.25-2cu";
	NEON_BACKUP_PROFILE_ID: "neon-free-restore-6h";
	VERCEL_API_BASE_URL: "https://api.vercel.com";
	VERCEL_TEAM_ID: "team_AB0nAOId1mR7gHxPldsG9f2u";
	VERCEL_BUILD_RECIPE_ID: "spa-plus-http-handlers-v1";
	RESEND_API_BASE_URL: "https://api.resend.com";
	RESEND_SMTP_PROFILE_ID: "resend-eu-west-1";
	RESEND_SENDER_DOMAIN: "mail.ciphercross.dev";
	RESEND_FROM_EMAIL: "noreply@mail.ciphercross.dev";
	RESEND_FROM_IDENTITY: "CipherCross <noreply@mail.ciphercross.dev>";
	RESEND_SMOKE_RECIPIENT: "accounts@ciphercross.com";
	BETTER_AUTH_BASE_URL: "https://s26-disposable-lab.vercel.app";
	BETTER_AUTH_TEMPLATE_SET_ID: "s26-self-hosted-better-auth-v1";
	RELEASE_COMPATIBILITY_ID: "s26-neon-hosting-v1";
	APPROVED_APPLICATION_VERSION: "s26-b2c287a";
	APPROVED_SCHEDULE_MANIFEST_DIGEST: "sha256:688baed28906755e59c836917b63626a44d00b2c544a7a82fe98b2cafe492ebc";
	SOURCE_REPOSITORY_API_BASE_URL: "https://api.github.com";
	SOURCE_REPOSITORY_OWNER: "CipherCross";
	SOURCE_REPOSITORY_NAME: "cipher-linkedin-dashboard";
	APPROVED_SOURCE_GIT_SHA: "b2c287af68b5afe46deee27aa3eb829ed0297c60";
	RECOVERY_OBJECT_PREFIX: "s26-control-plane/recovery/v1";
	BRIDGE_BEARER_SECRET: string;
	NEON_API_TOKEN: string;
	VERCEL_API_TOKEN: string;
	RESEND_API_KEY: string;
	SOURCE_REPOSITORY_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEON_API_BASE_URL" | "NEON_ORGANIZATION_ID" | "NEON_DATABASE_NAME" | "NEON_OWNER_ROLE_NAME" | "NEON_APPLICATION_ROLE_NAME" | "NEON_AI_ROLE_NAME" | "NEON_MACHINE_ROLE_NAME" | "NEON_IDENTITY_STORE_ROLE_NAME" | "S26_APPLICATION_HOSTING_CONTRACT" | "S26_APPLICATION_DATA_PLANE_READY" | "NEON_REGION_ID" | "NEON_TIER_ID" | "NEON_COMPUTE_ID" | "NEON_BACKUP_PROFILE_ID" | "VERCEL_API_BASE_URL" | "VERCEL_TEAM_ID" | "VERCEL_BUILD_RECIPE_ID" | "RESEND_API_BASE_URL" | "RESEND_SMTP_PROFILE_ID" | "RESEND_SENDER_DOMAIN" | "RESEND_FROM_EMAIL" | "RESEND_FROM_IDENTITY" | "RESEND_SMOKE_RECIPIENT" | "BETTER_AUTH_BASE_URL" | "BETTER_AUTH_TEMPLATE_SET_ID" | "RELEASE_COMPATIBILITY_ID" | "APPROVED_APPLICATION_VERSION" | "APPROVED_SCHEDULE_MANIFEST_DIGEST" | "SOURCE_REPOSITORY_API_BASE_URL" | "SOURCE_REPOSITORY_OWNER" | "SOURCE_REPOSITORY_NAME" | "APPROVED_SOURCE_GIT_SHA" | "RECOVERY_OBJECT_PREFIX" | "BRIDGE_BEARER_SECRET" | "NEON_API_TOKEN" | "VERCEL_API_TOKEN" | "RESEND_API_KEY" | "SOURCE_REPOSITORY_TOKEN">> {}
}
declare module "*.sql" {
	const value: string;
