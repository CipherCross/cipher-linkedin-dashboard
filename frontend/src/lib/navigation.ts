...
const ITEMS: Record<string, Omit<NavigationItem, 'section'>> = {
  ...
  replies: {
    id: 'replies',
    to: routeTo(APP_ROUTE_SEGMENTS.replies),
    label: 'Replies',
    icon: ClipboardCheck,
    skeleton: 'table',
    keywords: ['inbox', 'responses', 'manual review'],
  },
  pipeline: {
    id: 'pipeline',
  ...
  sentimentAnalysis: {
    ...
    to: routeTo(APP_ROUTE_SEGMENTS.sentimentAnalysis),
    label: 'Sentiment Analysis',
    icon: Activity,
    skeleton: 'overview',
    keywords: ['replies', 'sentiment', 'reasons', 'analytics'],
  },
  playbook: {
    id: 'playbook',
...
export const NAVIGATION_SECTIONS: NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      inSection('strategy', ITEMS.sentimentAnalysis),
