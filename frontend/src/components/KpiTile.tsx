...
export const KPI_TILE = 'flex flex-col gap-app-xs min-w-0 bg-app-surface border border-app-border rounded-card p-app-lg'

/** The row the tiles wrap in; each tile grows from 220px. */
export function KpiGrid({ children }: { children: ReactNode }) {
  return <div className="flex flex-wrap gap-app-lg mb-app-xl">{children}</div>
}
